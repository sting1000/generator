from classes.entity_maker.helper import make_hour, make_minute, make_second, make_position
from classes.entity_maker.helper import make_timestamp_date, make_timestamp_clock, make_timestamp_word
